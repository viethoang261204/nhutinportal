  ...
  <body>
    ...
    <main id="main">
      <section class="main-banner" id="top">
        <div class="container">
          <div class="banner-content" data-reveal>
            ...
            <p class="banner-subtitle">Tiên phong ứng dụng nhiên liệu sinh khối bã điều cho lò hơi công nghiệp và triển khai hệ thống sàn trượt tự đổ – giải pháp tối ưu chi phí và nâng cao hiệu suất vận hành.</p>
            <div class="banner-actions">
              <a class="btn primary large" href="products.html">Xem sản phẩm</a>
              <a class="btn large" href="about.html">Về chúng tôi</a>
              <a class="btn large" href="contact.html">Liên hệ ngay</a>
            </div>
          </div>
          <div class="banner-features">
            <div class="banner-feature-main" data-reveal>
              <h3>Tại sao chọn chúng tôi?</h3>
              <p>Tối ưu chi phí — tăng hiệu suất — vận hành ổn định. Chúng tôi cung cấp giải pháp toàn diện từ tư vấn, triển khai đến bảo trì, giúp doanh nghiệp kiểm soát chi phí năng lượng và tối ưu quy trình xếp dỡ.</p>
            </div>
            <div class="banner-feature-right">
              <div class="banner-feature-card small" data-reveal>
                ...
                <h3>Tự động hóa xuống hàng</h3>
                <p>Giảm nhân công, giảm thời gian chờ xe, tăng vòng quay kho bãi.</p>
              </div>
              <div class="banner-feature-card small" data-reveal>
                ...
                <h3>Sinh khối bã điều</h3>
                <p>Tiết kiệm chi phí đến 50% so với đốt than, nguồn cung ổn định.</p>
              </div>
              <div class="banner-feature-card small" data-reveal>
                ...
                <p>Tư vấn, triển khai và hỗ trợ vận hành theo từng dự án.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section" id="products">
        <div class="container">
          <div data-reveal>
            <h2 class="h2">Giải pháp toàn diện từ NHUTIN</h2>
            <p class="sub">Chúng tôi tập trung vào nhiên liệu sinh khối bã điều và hệ thống sàn trượt tự đổ. Mỗi dịch vụ đều có website chuyên biệt với đội ngũ chuyên môn và giải pháp tối ưu cho từng nhu cầu.</p>
          </div>
          <div class="grid twoCol" style="margin-top: 18px; align-items: stretch;">
            <article class="card padded solid" data-reveal style="display: flex; flex-direction: column;">
              <div class="mediaTop"><img src="img/product2_a.jpg" alt="Nhiên liệu sinh khối bã điều" /></div>
              <h3 style="margin: 16px 0 0; font-size: 18px">Nhiên liệu sinh khối bã điều</h3>
              ...
              <p class="sub">Tiên phong ứng dụng bã vỏ hạt điều (sau ép dầu) cho lò hơi công nghiệp — giải pháp tiết kiệm chi phí và thân thiện môi trường cho các nhà máy.</p>
              <ul class="list" style="flex-grow: 1;">
                <li>Tiết kiệm chi phí năng lượng lên tới 50% so với than truyền thống</li>
                <li>Giao hàng nhanh chóng bằng hệ thống đội xe chuyên dụng</li>
                <li>Tư vấn vận hành lò hơi & xử lý khói thải đạt chuẩn môi trường</li>
                <li>Nguồn cung ổn định từ vùng nguyên liệu tập trung</li>
              </ul>
              <div class="hero-actions" style="margin-top: 16px; display: flex; gap: 10px;">
                <a class="btn primary" href="products.html#biomass" style="flex: 1;">Xem chi tiết</a>
                <a class="btn" href="https://bavohatdieu.com" target="_blank" rel="noopener noreferrer" style="flex: 1;">Tới bavohatdieu.com</a>
              </div>
            </article>
            <article class="card padded solid" data-reveal style="display: flex; flex-direction: column;">
              <div class="mediaTop"><img src="img/product1_a.jpg" alt="Sàn trượt tự đổ" /></div>
              <h3 style="margin: 16px 0 0; font-size: 18px">Sàn trượt tự đổ</h3>
              ...
              <p class="sub">NHUTIN Coporation là đại lý ủy quyền của KEITH® (Mỹ) tại Việt Nam, triển khai hệ thống sàn trượt tự đổ — giải pháp tự động hóa xuống hàng giúp tối ưu logistics và kho bãi.</p>
              <ul class="list" style="flex-grow: 1;">
                <li>Xuống hàng tự động nhanh chóng, giảm thời gian chờ xe đến 70%</li>
                <li>Phù hợp tải trọng lớn (20-40 tấn), bền bỉ trong môi trường khắc nghiệt</li>
                <li>Lắp đặt linh hoạt, cải tạo được cho xe container và thùng xe sẵn có</li>
                <li>Giảm nhân công, tăng an toàn lao động và vòng quay kho bãi</li>
              </ul>
              <div class="hero-actions" style="margin-top: 16px; display: flex; gap: 10px;">
                <a class="btn primary" href="products.html#walking-floor" style="flex: 1;">Xem chi tiết</a>
                <a class="btn" href="https://thungxetudo.com" target="_blank" rel="noopener noreferrer" style="flex: 1;">Tới thungxetudo.com</a>
              </div>
            </article>
          </div>
        </div>
      ...
      <section class="section">
        <div class="container">
          <div class="grid twoCol">
            <div data-reveal>
              <h2 class="h2">Nhìn nhanh quy trình & ứng dụng thực tế</h2>
              <p class="sub">Video ngắn giúp bạn hình dung cách vận hành và ứng dụng, từ đó quyết định phương án phù hợp cho doanh nghiệp.</p>
              <div class="hero-actions" style="margin-top: 14px">
                <a class="btn primary" href="contact.html">Liên hệ</a>
                <a class="btn" href="about.html">Về NHUTIN</a>
              </div>
            </div>
      ...
      <section class="section">
        <div class="container">
          <div data-reveal>
            <h2 class="h2">Kiến thức & cập nhật</h2>
            <p class="sub">Chia sẻ ngắn gọn, tập trung vào ứng dụng thực tế và tối ưu vận hành.</p>
          </div>
...
<?php endforeach; endif; ?>
          ...
          <div class="hero-actions" style="margin-top: 18px" data-reveal>
            <a class="btn primary" href="news.php">Xem tất cả tin tức</a>
          </div>
        </div>
      </section>
